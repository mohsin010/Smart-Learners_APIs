...
class FreelancerServicesController {
    ...
    async updateStatus(req, res) {
        try {
            ...
            let updatedStatus = await FreelanceServices.updateService(criteria, details)


            res.status(200).send(ResponseService.success({ service: updatedStatus }))
    ...
    async deleteService(req, res) {
        try {
            ...
            let serviceDeleted = await FreelanceServices.deleteOneService(criteria)


            res.status(200).send(ResponseService.success({ service: serviceDeleted }))
