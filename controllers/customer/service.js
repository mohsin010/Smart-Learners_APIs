...
class ServiceController {
    ...
    async searchServices(req, res) {
        try {
            ...
            let getServices = await Services.searchService(criteria)
            return res.status(200).send(ResponseService.success({ services: getServices }));
    ...
    async searchFreelancerServices(req, res) {
        try {
            let data = Object.assign({}, req.body)
            let services = []
            ...
            let getervices = await FreelanceServices.searchService(criteria)
